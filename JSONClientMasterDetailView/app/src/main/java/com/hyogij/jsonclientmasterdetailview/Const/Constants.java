...
public class Constants {
    public static final String URL_PREFIX = "http://jsonplaceholder.typicode.com";
    public static final String USER_REQUEST_URL = URL_PREFIX + "/users";
    public static final String ALBUM_REQUEST_URL = URL_PREFIX + "/albums?userId=";
    public static final String PICTURE_REQUEST_URL = URL_PREFIX + "/photos?albumId=";
    public static final String POST_REQUEST_URL = URL_PREFIX + "/posts?userId=";
    public static final String COMMENT_REQUEST_URL = URL_PREFIX + "/comments?postId=";
